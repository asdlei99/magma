...
constexpr GeneralShaderGroup::GeneralShaderGroup(uint32_t generalShader,
...
constexpr TrianglesHitShaderGroup::TrianglesHitShaderGroup(uint32_t closestHitShader,
...
constexpr ProceduralHitShaderGroup::ProceduralHitShaderGroup(uint32_t intersectionShader,
